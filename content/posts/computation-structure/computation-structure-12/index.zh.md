...
![](assets/implementing-procedures.png)
...
![](assets/procedure-calling-concention.png)

![](assets/procedure-linkage-first-try.png)
...
![](assets/procedure-storage-needs.png)
...
![](assets/activation-record.png)

这不就是先进后出的Stack嘛！然后就是一系列的有关于Stack的定义了。

![](assets/we-need-a-stack.png)

![](assets/stack-implementation.png)

![](assets/stack-management-macros.png)

## Stack frame

现在我们用Stack来解决之前的问题了！

![](assets/solving-procedure-linkage-problems.png)
...
![](assets/stack-frame-as-activation-record.png)

栈中一个procedure的相关数据都在连续的区块中，我们称这个区块为stack frame.

![](assets/stack-frame-details.png)

![](assets/arguments-order-and-bp-usage.png)

然后约定好caller和callee的职责，就可以开心地使用procedure啦！

![](assets/procedure-linkage-contract.png)

![](assets/procedure-linkage-template.png)

## Compile procedure

如下是将C的一个递归调用编译成汇编的例子。

![](assets/procedure-factorial.png)

![](assets/recursion.png)

![](assets/stack-detective.png)

## Summary

![](assets/procedure-stack-summary.png)
