...
![](assets/assembly-language.png)

本课程中使用的汇编语言叫*USAM*，课程Lab里面有详细的cookbook, 就不再记录了，下面主要记录图灵机相关的内容。

![](assets/assembly-language-summary.png)
...
![](assets/uncomputability.png)

![](assets/why-fh-is-uncomputable.png)