...
![](https://blog-img.rmtt.fun/posts/computation-structure-10/assembly-language.png)

本课程中使用的汇编语言叫*USAM*，课程Lab里面有详细的cookbook, 就不再记录了，下面主要记录图灵机相关的内容。

![](https://blog-img.rmtt.fun/posts/computation-structure-10/assembly-language-summary.png)
...
![](https://blog-img.rmtt.fun/posts/computation-structure-10/fsm-limitation.png)
...
![](https://blog-img.rmtt.fun/posts/computation-structure-10/turing-machine.png)
...
![](https://blog-img.rmtt.fun/posts/computation-structure-10/computability.png)
...
![](https://blog-img.rmtt.fun/posts/computation-structure-10/the-universal-function.png)

如上图所示，$U(k, j) = T_k[j]$是一个Universal Function, 实现这个函数的图灵机便是通用图灵机。

实际上，这里的关键在于$k$。

![](https://blog-img.rmtt.fun/posts/computation-structure-10/universality.png)
...
![](https://blog-img.rmtt.fun/posts/computation-structure-10/coded-algorithms.png)
...
![](https://blog-img.rmtt.fun/posts/computation-structure-10/uncomputability.png)

![](https://blog-img.rmtt.fun/posts/computation-structure-10/why-fh-is-uncomputable.png)