...
![](assets/plea-for-lenience.png)

![](assets/little-displine-for-d-latch.png)
...
![](assets/flaky-control-system-1.png)

![](assets/flaky-control-system-2.png)

### D-Register

我们可以按如上的例子用D-latch来实现一个这样的系统。

![](assets/d-register.png)

### 各种时序图

理解D-Register的时序很重要！！！

![](assets/D-Register-waveforms.png)

![](assets/D-Register-hold-time.png)

![](assets/D-Register-timeing-1.png)

## Summary

![](assets/sequential-logic-summary.png)
